...
const MovieDetails = () => {
  ...
  if (isLoading) return <p className="text-white text-center">Loading movie details...</p>;
  ...
  return (
    <div className="bg-gray-900 text-white min-h-screen p-6">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-2/3">
          ...
          <div className="flex items-center gap-4 mt-4">
            <div className="flex items-center text-yellow-400">⭐ {movie.vote_average}/10</div>
            <div className="flex items-center text-green-400">❤️ {movie.vote_count}</div>
      ...
      {/* Similar Movies (Static placeholder) */}
      <div className="mt-10">
